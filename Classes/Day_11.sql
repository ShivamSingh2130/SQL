...
User-defined functions (UDFs) in MySQL allow you to create your own functions
 that can be used in SQL statements, just like built-in functions. UDFs can
 encapsulate complex logic, perform calculations, or manipulate data, making your SQL queries cleaner and more efficient. 
...
BEGIN
 ...
 DELIMITER ;
    ...
    -- This function substract two integer and returns the result
...
BEGIN
 ...
 DELIMITER ;
	...
	-- USE THE FUNCTION
    SELECT sub_numbers(10,5)AS sub; -- Returns 5
    
    -- This function multiply two integer and returns the result
    
      DELIMITER //
CREATE FUNCTION mul_numbers(a INT, b INT)
RETURNS INT 
DETERMINISTIC 
BEGIN
 RETURN a*b;
 ...
 DELIMITER ;
	...
	-- USE THE FUNCTION
    SELECT mul_numbers(5,10); -- Returns 50
    
    -- This function devide two integer and returns the result
    
      DELIMITER //
CREATE FUNCTION div_numbers (a INT, b INT)
RETURNS INT 
DETERMINISTIC 
BEGIN
 RETURN a/b;
 END // 
	...
	-- USE THE FUNCTION
    SELECT div_numbers(5,10); -- Returns 50
...
DELIMITER ; 
-- Use the Function 
SELECT full_name('Shivam','Singh') AS name; -- Returns 'Shivam Singh'
...
DELIMITER ; 
-- Use the Function 
SELECT calculate_age('2003-06-30') AS age; -- Returns the age based on the current date
...
SELECT is_even_or_odd (8) AS result; -- Returns 'Odd' 
